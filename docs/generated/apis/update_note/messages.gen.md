...
| --- | --- | --- | --- |
| update_note.completed | INFO | 200–399 | APIの処理が完了しました |
| update_note.rejected | WARNING | 400–499 | 認証・入力・対象状態によりリクエストを拒否しました |
| update_note.failed | ERROR | 500–599 | APIの処理中に障害が発生しました |
...
| 出力項目 | 値 |
| --- | --- |
| message_id | update_note.completed |
| message | APIの処理が完了しました |
| operation | update_note |
| status | 200 |
| exception_type | 捕捉した例外のクラス名。正常応答はnull |

### update_note.rejected

| 出力項目 | 値 |
| --- | --- |
| message_id | update_note.rejected |
