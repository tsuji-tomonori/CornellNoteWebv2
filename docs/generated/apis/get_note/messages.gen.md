...
| --- | --- | --- | --- |
| get_note.completed | INFO | 200–399 | APIの処理が完了しました |
| get_note.rejected | WARNING | 400–499 | 認証・入力・対象状態によりリクエストを拒否しました |
| get_note.failed | ERROR | 500–599 | APIの処理中に障害が発生しました |
