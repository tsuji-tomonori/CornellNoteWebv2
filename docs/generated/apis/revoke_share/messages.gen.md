...
| --- | --- | --- | --- |
| revoke_share.completed | INFO | 200–399 | APIの処理が完了しました |
| revoke_share.rejected | WARNING | 400–499 | 認証・入力・対象状態によりリクエストを拒否しました |
| revoke_share.failed | ERROR | 500–599 | APIの処理中に障害が発生しました |

## ログ詳細

### revoke_share.completed

| 出力項目 | 値 |
| --- | --- |
| message_id | revoke_share.completed |
| message | APIの処理が完了しました |
| operation | revoke_share |
| status | 204 |
| exception_type | 捕捉した例外のクラス名。正常応答はnull |

### revoke_share.rejected

| 出力項目 | 値 |
| --- | --- |
| message_id | revoke_share.rejected |
...
| 出力項目 | 値 |
| --- | --- |
| message_id | revoke_share.failed |
