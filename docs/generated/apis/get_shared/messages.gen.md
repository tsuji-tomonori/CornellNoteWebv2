...
| --- | --- | --- | --- |
| get_shared.completed | INFO | 200–399 | APIの処理が完了しました |
| get_shared.rejected | WARNING | 400–499 | 認証・入力・対象状態によりリクエストを拒否しました |
| get_shared.failed | ERROR | 500–599 | APIの処理中に障害が発生しました |

## ログ詳細

### get_shared.completed

| 出力項目 | 値 |
| --- | --- |
| message_id | get_shared.completed |
