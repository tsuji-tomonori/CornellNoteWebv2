...
| 409 | 更新が競合しました。再読み込みしてください | [backend/src/app/apis/notes/delete_note/functions.py:23](https://github.com/tsuji-tomonori/CornellNoteWebv2/blob/dev/backend/src/app/apis/notes/delete_note/functions.py#L23) |
