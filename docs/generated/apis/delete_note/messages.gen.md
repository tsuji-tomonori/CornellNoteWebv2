...
| --- | --- | --- | --- |
| delete_note.completed | INFO | 200–399 | APIの処理が完了しました |
| delete_note.rejected | WARNING | 400–499 | 認証・入力・対象状態によりリクエストを拒否しました |
| delete_note.failed | ERROR | 500–599 | APIの処理中に障害が発生しました |

## ログ詳細

### delete_note.completed

| 出力項目 | 値 |
| --- | --- |
| message_id | delete_note.completed |
| message | APIの処理が完了しました |
| operation | delete_note |
| status | 204 |
| exception_type | 捕捉した例外のクラス名。正常応答はnull |

### delete_note.rejected

| 出力項目 | 値 |
| --- | --- |
| message_id | delete_note.rejected |
